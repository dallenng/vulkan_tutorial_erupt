...
use erupt::vk::{
    make_api_version, ApplicationInfoBuilder, BlendFactor, BlendOp, ColorComponentFlags,
    ...
    Extent2DBuilder, Format, FrontFace, Image, ImageAspectFlags, ImageSubresourceRangeBuilder,
    ImageUsageFlags, ImageView, ImageViewCreateInfoBuilder, ImageViewType,
    InstanceCreateInfoBuilder, LogicOp, Offset2DBuilder, PhysicalDevice,
    PhysicalDeviceFeaturesBuilder, PipelineColorBlendAttachmentStateBuilder,
    ...
    PresentModeKHR, PrimitiveTopology, Rect2DBuilder, SampleCountFlagBits, ShaderModule,
    ShaderModuleCreateInfoBuilder, ShaderStageFlagBits, SharingMode, SurfaceCapabilitiesKHR,
...
impl VulkanApp {
    pub fn new(window: &Window) -> VkResult<Self> {
        ...
        let pipeline_layout = Self::create_graphics_pipeline(&device, swapchain.extent)?;
