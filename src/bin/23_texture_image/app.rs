...
use erupt::vk::{
    ...
    BufferCopyBuilder, BufferCreateInfoBuilder, BufferImageCopyBuilder, BufferUsageFlags,
    ...
    CommandBufferUsageFlags, CommandPool, CommandPoolCreateInfoBuilder, ComponentMappingBuilder,
    ComponentSwizzle, CompositeAlphaFlagBitsKHR, CullModeFlags, DescriptorBufferInfoBuilder,
    DescriptorPool, DescriptorPoolCreateInfoBuilder, DescriptorPoolSizeBuilder, DescriptorSet,
    DescriptorSetAllocateInfoBuilder, DescriptorSetLayout, DescriptorSetLayoutBindingBuilder,
    DescriptorSetLayoutCreateInfoBuilder, DescriptorType, DeviceCreateInfoBuilder, DeviceMemory,
    DeviceQueueCreateInfoBuilder, DeviceSize, Extent2D, Extent2DBuilder, Extent3D, Extent3DBuilder,
    FenceCreateFlags, FenceCreateInfoBuilder, Format, Framebuffer, FramebufferCreateInfoBuilder,
    FrontFace, GraphicsPipelineCreateInfoBuilder, Image, ImageAspectFlags, ImageCreateInfoBuilder,
    ...
    RenderPassBeginInfoBuilder, RenderPassCreateInfoBuilder, SampleCountFlagBits,
    SemaphoreCreateInfoBuilder, ShaderModule, ShaderModuleCreateInfoBuilder, ShaderStageFlagBits,
    ShaderStageFlags, SharingMode, SubmitInfoBuilder, SubpassContents, SubpassDependencyBuilder,
...
const VERTEX_SHADER_CODE: &[u8] = include_bytes!("../../../shaders/21_shader_ubo.vert.spv");
const FRAGMENT_SHADER_CODE: &[u8] = include_bytes!("../../../shaders/21_shader_ubo.frag.spv");
...
impl VulkanApp {
    ...
    fn create_descriptor_set_layout(device: &DeviceLoader) -> VkResult<DescriptorSetLayout> {
        ...
        let layout_info = DescriptorSetLayoutCreateInfoBuilder::new()
    ...
    fn create_descriptor_pool(device: &DeviceLoader, images: &[Image]) -> VkResult<DescriptorPool> {
        ...
        let pool_size = DescriptorPoolSizeBuilder::new()
