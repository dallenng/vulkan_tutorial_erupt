...
use erupt::vk::{
    ...
    Extent2DBuilder, Format, FrontFace, GraphicsPipelineCreateInfoBuilder, Image, ImageAspectFlags,
    ImageLayout, ImageSubresourceRangeBuilder, ImageUsageFlags, ImageView,
