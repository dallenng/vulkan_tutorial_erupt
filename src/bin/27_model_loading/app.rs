...
use erupt::vk::{
    ...
    ImageUsageFlags, ImageView, ImageViewCreateInfoBuilder, ImageViewType, IndexType,
    InstanceCreateInfoBuilder, LogicOp, MemoryAllocateInfoBuilder, MemoryPropertyFlags,
...
impl VulkanApp {
    ...
    fn create_image_views(
        ...
        images
            .iter()
            .map(|image| {
                Self::create_image_view(device, *image, image_format, ImageAspectFlags::COLOR)
            })
            .collect()
    }
    ...
    fn create_depth_resources(
        ...
        let depth_image_view =
            Self::create_image_view(device, depth_image, depth_format, ImageAspectFlags::DEPTH)?;
