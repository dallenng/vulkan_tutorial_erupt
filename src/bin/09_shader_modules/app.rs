...
use erupt::vk::{
    ...
    PipelineShaderStageCreateInfoBuilder, PresentModeKHR, ShaderModule,
    ShaderModuleCreateInfoBuilder, ShaderStageFlagBits, SharingMode, SurfaceCapabilitiesKHR,
    SurfaceFormatKHR, SurfaceKHR, SwapchainCreateInfoKHRBuilder, API_VERSION_1_0,
...
impl VulkanApp {
    ...
    fn create_graphics_pipeline(device: &DeviceLoader) -> VkResult<()> {
