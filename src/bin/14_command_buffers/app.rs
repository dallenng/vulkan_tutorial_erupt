...
use erupt::vk::{
    ...
    AttachmentReferenceBuilder, AttachmentStoreOp, BlendFactor, BlendOp, ClearColorValue,
    ...
    CommandPool, CommandPoolCreateInfoBuilder, ComponentMappingBuilder, ComponentSwizzle,
    CompositeAlphaFlagBitsKHR, CullModeFlags, DeviceCreateInfoBuilder,
    DeviceQueueCreateInfoBuilder, Extent2D, Extent2DBuilder, Format, Framebuffer,
    ...
    ImageViewCreateInfoBuilder, ImageViewType, InstanceCreateInfoBuilder, LogicOp, Offset2DBuilder,
    ...
    SharingMode, SubpassContents, SubpassDescriptionBuilder, SurfaceCapabilitiesKHR,
    SurfaceFormatKHR, SurfaceKHR, SwapchainCreateInfoKHRBuilder, ViewportBuilder, API_VERSION_1_0,
    KHR_SWAPCHAIN_EXTENSION_NAME,
};
use erupt::{DeviceLoader, EntryLoader, InstanceLoader, SmallVec};
...
pub struct VulkanApp {
    _command_buffers: SmallVec<CommandBuffer>,
